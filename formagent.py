...
This script serves as the main entry point for the FormAgent tool suite.
...
log_file = os.path.join(log_dir, f"formagent_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="FormAgent - Intelligent Web Form Auto-Filling Agent")
    ...
    logger.info(f"Starting FormAgent with browser: {args.browser}")
